...
public class PublicationServiceImpl implements PublicationService {
    ...
    public PaginatedResponse<Publication, ItemFilterMetadata> getPaginatedPublications(String search, String isBookStateFilterActive, String bookStateFilter, String isGenreFilterActive, String genreFilter, String sortType, String currentPage) {
        ...
        PaginatedResponse<Publication, ItemFilterMetadata> response = pubDao.getPaginatedPublications(search, bookStateFilterActive, state, genreFilterActive, genre, sortType, currentPage);

        List<BookStateWrapper> bookStateWrapperList = pubDao.getBookStateQtyByPublication(search, genreFilterActive, genre);
        List<GenreWrapper> genreWrapperList = pubDao.getGenreQtyByPublication(search, bookStateFilterActive, state);
