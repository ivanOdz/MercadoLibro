...
public abstract class GenreFilterMetadata extends Metadata{
    ...
    public GenreFilterMetadata(int currentPage, int pageSize, int totalResults, String search, Genre genre, SortType sortType, List<GenreWrapper> genreWrapperList) {
        super(currentPage, totalResults, pageSize);
        this.search = search;
        this.isGenreFilterActive = genre != null;
