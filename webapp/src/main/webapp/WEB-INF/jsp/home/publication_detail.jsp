        ...
        <div class="uk-container uk-card uk-card-default"
            ...
            <div style="display: grid; justify-content: center; grid-template-columns: repeat(4, 1fr); gap: 20px;">
                ...
                <c:if test="${loggedUser.userId == publication.user.userId}">
                    <div style="text-align: center;display: flex;justify-content: center; align-items: center;grid-column: 1 / 2; grid-row: 3 / 4;">
                        <a class="edit-button" type="button" href="#modal-${publication.publicationId}" uk-toggle>
            ...
            <div id="modal-${publication.publicationId}" uk-modal>
                <div class="uk-modal-dialog">
                    ...
                    <div class="uk-modal-header">
                        ...
                        <div class="uk-margin">
                            ...
                            <c:set var="currentState" value="${publication.book.bookState.value}"/>
                        ...
                        <form action="<c:url value='/update_bookstate' />" method="post" class="uk-grid-large uk-grid" style="justify-content: center;">
                            <div class="uk-margin uk-width-1-1" style="display: flex; flex-direction: column; align-items: center;">
                                ...
                                <input type="hidden" name="book_id" value="${publication.book.bookId}" />
