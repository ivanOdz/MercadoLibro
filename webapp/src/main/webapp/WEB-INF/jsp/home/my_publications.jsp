    ...
    <div class="uk-grid ml-1 uk-margin-top mb-2" uk-grid>
      ...
      <div class="uk-width-3-4 col-content mb-1">
        <div  style="display:flex; justify-content: space-between; align-items: center;">
          <div><h2 class="mt-1">
            <spring:message code="publications.my_publications"/>
          </div>
...
<%--                    </a>--%>
                ...
                <c:if test="${publications.metadata.currentPage > 0}">
                  <li>
                    <c:url var="prevPageUrl" value="">
                      ...
                      <c:param name="sort-type" value="${publications.metadata.sortType.value}" />
                    </c:url>
                    <a href="${prevPageUrl}">
        ...
        <c:if test="${empty publications.data and empty publications.metadata.search}">
