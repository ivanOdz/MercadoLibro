...
<div class="uk-background-muted">
    <div class="uk-container main uk-align-center" style="margin-bottom: 2%;">
        ...
        <div class="row-container" style="margin-left: 2lh; place-items: center; display: flex;">
            ...
            <div>
                <p class="uk-text-medium"
                   style="font-size: 25px; max-width: 9lh; text-align: center; margin-left: 1lh;">
                ...
                <div class="column-container" style="margin-left: 10%;">
                    ...
                    <c:if test="${!(completeBooks.size() eq 0)}">
                        <div class="uk-container uk-margin-top">
                            <form:form action="${pageContext.request.contextPath}/exchange/initializeexchange"
                                       method="post"
            ...
            <c:if test="${loggedUser == null}">
                <div class="column-container" style="margin-left: 10%;">
                    <div class="uk-container uk-margin-top">
                        <a class="uk-button uk-button-default" href="${loginUrl}">
                            <spring:message code="hwc.login.submit"/>
                        </a>
                        <a class="uk-button uk-button-primary" href="${registerUrl}">
