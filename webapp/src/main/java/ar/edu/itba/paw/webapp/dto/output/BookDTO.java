...
public class BookDTO {
    ...
    public static BookDTO fromBook(final UriInfo uriInfo, final Book book){
        ...
        dto.self = uriInfo.getBaseUriBuilder().path("books").path(String.valueOf(book.getBookId())).build();
        dto.owner = uriInfo.getBaseUriBuilder().path("users").path(String.valueOf(book.getOwner().getUserId())).build();
        dto.bookModel = uriInfo.getBaseUriBuilder().path("book_models").path(String.valueOf(book.getBookModel().getBookModelId())).build();
